...
/**
 * Servlet implementation class Friends_posts
 */
@WebServlet("/Friends_posts")
public class Friends_posts extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   	 ...
   	 if(PostDB.select_all() != null){
		 for(Post post:PostDB.select_all()){
   	    ...
   	    request.setAttribute("sign_in_out", Sign_out);
   	 	request.setAttribute("Friends_posts", posts);
		getServletContext().getRequestDispatcher("/FriendsPosts.jsp").forward(request,response);
	}
